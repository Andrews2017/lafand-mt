...
bash scripts/train_sentencepiece.sh en zu ./data/enzu/JW/train ./data/enzu/spmodel 10000 10k
#train sentence piece of 20000 vocaulary over en-yo
bash scripts/train_sentencepiece.sh en zu ./data/enzu/JW/train ./data/enzu/spmodel 20000 20k
#train sentence piece of 40000 vocaulary over en-yo
bash scripts/train_sentencepiece.sh en zu ./data/enzu/JW/train ./data/enzu/spmodel 40000 40k
